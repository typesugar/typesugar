...
```typescript
import { hours, minutes, seconds, meters } from "@typesugar/units";
...
When you add or subtract, dimensions must match exactly. When you multiply or divide, dimensions combine:

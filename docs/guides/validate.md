...
Zero-cost validation macros and a library-agnostic `Schema` typeclass for typesugar. Compile-time type guards, assertions, and validation with rich error accumulation.

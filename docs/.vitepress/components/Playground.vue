...
// from ./playground-examples.ts which auto-discovers docs/examples/**/*.ts
    ...
    >
      ...
      <div class="toolbar" role="toolbar" aria-label="Playground controls">
        ...
        <div class="toolbar-center">
          ...
          <label
            class="strict-toggle"
            title="Strict mode: type-check transformed output (~200ms slower)"
          >
          ...
          <div class="editors-container">
            ...
            <div class="editor-panel output-panel">
              <div class="panel-header">
                ...
                <span class="panel-filename">{{ fileName.replace(/\.ts$/, ".js") }}</span>
              </div>

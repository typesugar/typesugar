...
/**
 * NOTE (PEP-050): This module is the **runtime-pure** registry of refinement
 * predicates, subtyping rules, and decidability info. It must NOT import
 * `typescript`. The compile-time type-fact extraction (which walks the TS AST)
 * lives in the sibling `./extract.ts` module, loaded only via `@typesugar/contracts/macros`.
 */
 ...
 */
export const REFINEMENT_PREDICATES: Record<string, string> = {};

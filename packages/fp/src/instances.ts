 ...
 */
export function flatMapEither<E>() {
  return {
 ...
 * unlike Validated's applicative operations that accumulate errors.
 * Use the Applicative instance for error accumulation.
 */

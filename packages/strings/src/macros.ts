/**
 * @typesugar/strings — Macro definitions (BUILD-TIME ONLY).
 *
 ...
 *
 * Provides the tagged-template macros: regex`...`, html`...`, fmt`...`, raw`...`.
 */
  ...
  expand(ctx: MacroContext, node: ts.TaggedTemplateExpression): ts.Expression {
    ...
    if (ts.isTemplateExpression(template)) {
      ...
      for (const span of template.templateSpans) {
        ...
        // exported from @typesugar/strings (the `.` entry). Users must import it
        // for generated code to work.

...
import type { Kind, HKT } from "@typesugar/fp/hkt";
...
describe("HKT Encoding", () => {
  describe("EffectF", () => {
    ...
    it("should preserve requirements type parameter", () => {
      ...
      type TestEffect = Kind<EffectF<never, TestService>, number>;
      // Type check passes if this compiles
      expect(true).toBe(true);
    });
  });
  ...
  describe("ChunkF", () => {
    it("should correctly encode Chunk type", () => {
      type TestChunk = Kind<ChunkF, number>;
  ...
  describe("EffectOptionF", () => {
    it("should encode Effect wrapping Option", () => {
      type TestEffectOption = Kind<EffectOptionF<never, never>, number>;
  ...
  describe("EffectEitherF", () => {
    it("should encode Effect wrapping Either", () => {
      type TestEffectEither = Kind<EffectEitherF<string, never, never>, number>;

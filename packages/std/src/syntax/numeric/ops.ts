 ...
 * OPERATOR syntax (`a + b`, `a - b`, `a * b`, `a / b`, `a ** b`) in the
 * importing file. This redefines native primitive operators, so it is a
 * separate, louder opt-in than the method form. Importing operators implies
 * methods (tier 3 ⊇ tier 2).
 *
 * ```ts
 ...
 */
export const __typesugar_syntax_operators_Numeric = true;

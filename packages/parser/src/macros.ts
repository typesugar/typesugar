/**
 * @typesugar/parser — Macro definitions (BUILD-TIME ONLY).
 *
 ...
 * code — the runtime `grammar` tagged-template fallback lives in the package's
 * `.` entry. See PEP-050.
 *
...
import { parseGrammarDef } from "./grammar.js";

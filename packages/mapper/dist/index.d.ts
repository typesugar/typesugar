interface TransformConfig<From, To> {
    /**
 ...
 */
declare function transformInto<From, To>(source: From, config?: TransformConfig<From, To>): To;

export { type TransformConfig, transformInto };

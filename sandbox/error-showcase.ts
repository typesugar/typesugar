...
// Compare to valid usage:
staticAssert(1 + 1 === 2, "Math works correctly");

// ============================================================================
// TS9219: staticAssert condition must be compile-time constant
// ============================================================================
// Error: "staticAssert condition must be a compile-time constant"

declare const dynamicCondition: boolean;
// MACRO ERROR: TS9219 - condition not known at compile time
staticAssert(dynamicCondition, "Dynamic conditions not allowed");
...
7. TS9217 - staticAssert(1+1===3) failed (IDE: requires macro package loading)

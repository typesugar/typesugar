...
// ============================================================================
// Error Catalog: Specialization (9600-9699)
// ============================================================================

export const TS9601: DiagnosticDescriptor = {
  code: 9601,
  severity: "warning",
...
Common reasons:
1. The dictionary is not registered in the instance registry
2. The function body could not be resolved (not a const or named function)
3. The function body contains patterns that prevent inlining:
   - Early returns (multiple return statements)
   - try/catch/finally blocks
   - Loops (for, while, do..while, for..of, for..in)
   - Mutable variable declarations (let without const)

To achieve zero-cost inlining:
- Register dictionaries with @instance or registerInstanceMethods()
- Use single-expression arrow functions or single-return block bodies
- Move complex control flow outside the specialized function`,
  seeAlso: "https://typesugar.dev/errors/TS9601",
};

export const TS9602: DiagnosticDescriptor = {
  code: 9602,
  severity: "info",
  category: DiagnosticCategory.Specialization,
  messageTemplate: "Auto-specialization of {function} skipped — {reason}",
  explanation: `The compiler detected a function call with a registered typeclass instance
but could not auto-specialize it. The code will work correctly but with runtime
dictionary passing overhead.

This is informational — auto-specialization is opportunistic. Use explicit
specialize() if you need guaranteed inlining.`,
  seeAlso: "https://typesugar.dev/errors/TS9602",
};
